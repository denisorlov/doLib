...
//            outerDiv.appendChild(headTable);
	...
	{// private functions
        ...
        initDragger = function(){
            ...
            thDragger.options.onEnd = function(event, th){
                var pageX = event.pageX,
                    nodeList = getSameLevelTh(th);//getSameLevelGroupTh(th);
                for(var i=0;i<nodeList.length;i++){// reset ClassNames
                ...
                for(var i=0;i<nodeList.length;i++){
                    ...
                    if(coords.left<=pageX && coords.right>=pageX){
                        var tr = nodeList[i].parentNode,
                            ...
                            tidx = nodeList[i].getAttribute(columnIndexAttrName),
        ...
        initRow = function(tr){
            ...
            $do.eventUtils.addEvent(tr, 'click',
                    function(e){
            ...
            $do.eventUtils.addEvent(tr, 'dblclick',
                    function(e){
                        if(typeof this.onRowDblClick == 'function'){
                            this.onRowDblClick(tr);
                        }
                    }
            );
        },
